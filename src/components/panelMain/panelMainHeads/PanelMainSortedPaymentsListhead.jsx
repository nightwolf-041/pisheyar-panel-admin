...
const PanelMainSortedPaymentsListhead = (props) => {
        ...
        <>
            ...
            <div className={classes.mainSectionHeader}>
                <div className={classes.mainSectionHeaderDescs}>
                    <h5 className={classes.mainSectionHeaderTitle}>لیست پرداخت ها</h5>
                    <p className={classes.mainSectionHeaderSubtitle}>بر اساس زمان</p>
                </div>
...
export default PanelMainSortedPaymentsListhead