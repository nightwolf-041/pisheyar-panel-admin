...
const PanelMainPermissionsListhead = (props) => {
        ...
        <>
            ...
            <div className={classes.mainSectionHeader}>
                <div className={classes.mainSectionHeaderDescs}>
                    <h5 className={classes.mainSectionHeaderTitle}>لیست دسترسی ها</h5>
                    <p className={classes.mainSectionHeaderSubtitle}>دسترسی</p>
                </div>
...
export default PanelMainPermissionsListhead