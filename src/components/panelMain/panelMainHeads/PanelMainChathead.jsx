// this file is header of panel main (/chat route) 
        ...
        <>
            ...
            <div className={classes.mainSectionHeader}>
                <div className={classes.mainSectionHeaderDescs}>
                    <h5 className={classes.mainSectionHeaderTitle}>صفحه چت ها</h5>
                    <p className={classes.mainSectionHeaderSubtitle}>خیلی تمیزه</p>
                </div>
            ...
            <div className={!props.showMainHeaderModal ?
                ...
                <div className={classes.mainSectionHeaderDropdownItem}>
                    <FontAwesomeIcon icon={faCloudDownloadAlt}
                        className={classes.mainSectionHeaderDropdownItemIcon} />
                    <button href="" className={classes.mainSectionHeaderDropdownItemText}>
                        تمام کاربران
                    </button>
                </div>
            </div>
...
export default PanelMainChathead