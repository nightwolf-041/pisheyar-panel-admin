...
const PanelMainSliderPostsListhead = (props) => {
        ...
        <>
            ...
            <div className={classes.mainSectionHeader}>
                <div className={classes.mainSectionHeaderDescs}>
                    <h5 className={classes.mainSectionHeaderTitle}>لیست پست های اسلایدر</h5>
                    {/* <p className={classes.mainSectionHeaderSubtitle}>پست اسلایدر</p> */}
                </div>
...
export default PanelMainSliderPostsListhead