...
const PanelMainPostCreatehead = (props) => {
        ...
        <>
            ...
            <div className={classes.mainSectionHeader}>
                <div className={classes.mainSectionHeaderDescs}>
                    <h5 className={classes.mainSectionHeaderTitle}>صفحه ساخت پست</h5>
                    <p className={classes.mainSectionHeaderSubtitle}>پستتو بساز</p>
                </div>
...
export default PanelMainPostCreatehead