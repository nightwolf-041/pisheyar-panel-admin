...
const PanelMainContactUsListhead = (props) => {
        ...
        <>
            ...
            <div className={classes.mainSectionHeader}>
                <div className={classes.mainSectionHeaderDescs}>
                    <h5 className={classes.mainSectionHeaderTitle}>لیست پیام های ارتباط با ما</h5>
                    {/* <p className={classes.mainSectionHeaderSubtitle}>ارتباط با ما</p> */}
                </div>
...
export default PanelMainContactUsListhead