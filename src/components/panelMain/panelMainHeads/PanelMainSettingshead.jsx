...
const PanelMainSettingshead = (props) => {
        ...
        <>
            ...
            <div className={classes.mainSectionHeader}>
                <div className={classes.mainSectionHeaderDescs}>
                    <h5 className={classes.mainSectionHeaderTitle}>صفحه تنظیات</h5>
                    <p className={classes.mainSectionHeaderSubtitle}>خیلی تنظیمات داره</p>
                </div>
...
export default PanelMainSettingshead