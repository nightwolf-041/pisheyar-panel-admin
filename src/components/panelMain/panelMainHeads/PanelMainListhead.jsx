// this file is header of panel main (/list route) 
        ...
        <>
            ...
            <div className={classes.mainSectionHeader}>
                <div className={classes.mainSectionHeaderDescs}>
                    <h5 className={classes.mainSectionHeaderTitle}>خانه ما</h5>
                    <p className={classes.mainSectionHeaderSubtitle}>خیلی گشنگه</p>
                </div>
                <div className={classes.mainSectionHeaderIcons}>
                    <BootstrapTooltip placement="right" title="افزودن">
                        ...
                        <FontAwesomeIcon icon={faPlus}
                            ...
                            onClick={props.showAddModalHandler}/>
                        </div>
                    </BootstrapTooltip>
...
export default PanelMainListhead