...
import ChangeSuggestionDialog from '../../UI/dialogs/ChangeSuggestionDialog'
...
class PostsList extends React.Component{
    ...
    chekoutOfSuggestionHandler = () => {
      ...
      axiosConfig.post('/Post/ChangeSuggestionStatus', {
        postGuid: this.state.suggestionDialogData.postGuid,
                    ...
                    <MaterialTable
                        ...
                        actions={[
                            ...
                            },
                            {
                              ...
                              tooltip: 'نمایش در منتخبین سردبیر',
                              onClick: (event, rowData) => {
                                this.setState({
