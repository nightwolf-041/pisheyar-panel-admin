...
import PanelMainPaymentsListshead from '../../panelMain/panelMainHeads/PanelMainPaymentsListshead'
...
class PaymentsList extends React.Component{
    ...
    render() {
        return (
            ...
            <PanelMain header={<PanelMainPaymentsListshead />}>
                {
                  this.state.loading ?
...
export default connect(mapState)(withRouter(PaymentsList))