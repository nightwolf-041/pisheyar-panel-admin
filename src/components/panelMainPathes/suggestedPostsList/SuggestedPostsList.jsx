...
import PanelMainSuggestedPostsListhead from '../../panelMain/panelMainHeads/PanelMainSuggestedPostsListhead'
...
class SuggestedPostsList extends React.Component{
    ...
    componentDidMount() {
        ...
        axiosConfig.get('/Post/GetSuggestedPosts', {
    ...
    render() {
        return (
            <>
            <PanelMain header={<PanelMainSuggestedPostsListhead />}>
                {
                  this.state.loading ?
...
export default connect(mapState, mapDispatch)(withRouter(SuggestedPostsList))