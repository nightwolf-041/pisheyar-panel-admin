...
class ProvincesList extends React.Component{
    ...
    componentDidMount() {
        ...
        axiosConfig.get(`/Account/Provinces/${this.props.provinceGuid}/Cities`, {
                ...
                <div style={{ width: "100%" }} dir="rtl">
                    <MaterialTable
                        ...
                        actions={[
                            ...
                            //     this.props.onSaveProvincesGuid(rowData.provinceGuid)
                            //     this.props.history.push('/citiesList' )
                            //     this.props.history.state = 'showCitiesList'
                            //   }
                            // },
                        ]}
...
const mapState = state => {
    return {
      ...
      provinceGuid: state.pages.provinceGuid,
    }
}

// const mapDispatch = dispatch => {
//     return {
//         onSaveProvincesGuid: (provinceGuid) => dispatch(pagesActionCreators.saveProvincesGuid(provinceGuid))
//     }
// }

export default connect(mapState)(withRouter(ProvincesList))