...
import PanelMainRolesListhead from '../../panelMain/panelMainHeads/PanelMainRolesListhead'
...
class RolesList extends React.Component{
    ...
    render() {
        return (
            ...
            <PanelMain header={<PanelMainRolesListhead />}>
                {
                  this.state.loading ?
...
export default connect(mapState, mapDispatch)(withRouter(RolesList))