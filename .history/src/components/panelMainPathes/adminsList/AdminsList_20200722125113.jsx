...
import PanelMainAdminsListhead from '../../panelMain/panelMainHeads/PanelMainAdminsListhead'
...
import AdminCreateModal from '../../UI/Modals/AdminCreateModal'
...
class AdminsList extends React.Component{
    ...
    showAdminCreateModal = () => {
      this.setState({showAdminCreateModal: true})
    }

    hideAdminCreateModal = () => {
      this.setState({showAdminCreateModal: false})
    }
    ...
    render() {
        return (
            ...
            <PanelMain header={<PanelMainAdminsListhead showModal={this.showAdminCreateModal} />}>
                {
                  this.state.loading ?
                    ...
                    <MaterialTable
                        ...
                        onRowDelete: oldData =>
                          ...
                          new Promise((resolve, reject) => {
                            ...
                            axiosConfig
                              .post(`/Account/Delete?userGuid=${oldData.userGuid}`, {
                                headers: { Authorization: "Bearer " + this.props.token }
                            }).then(res => {
              ...
              <PersonDisablerDialog
                ...
                <AdminCreateModal 
                showAdminCreateModal={this.state.showAdminCreateModal}
                hideAdminCreateModal={this.hideAdminCreateModal}
...
export default connect(mapState, mapDispatch)(withRouter(AdminsList))