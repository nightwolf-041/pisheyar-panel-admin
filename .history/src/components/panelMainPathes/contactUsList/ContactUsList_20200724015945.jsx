...
import PanelMainContactUsListhead from '../../panelMain/panelMainHeads/PanelMainContactUsListhead'
...
class ContactUsList extends React.Component{
    ...
    constructor(props){
        ...
        this.state = {
          ...
          columns: [
            ...
            {
              field: "contactUsBusinessTypeCode",
              title: "نوع کسب و کار",
                options: {
                    filter: true,
                    sort: true
    ...
    render() {
        return (
            <>
            <PanelMain header={<PanelMainContactUsListhead />}>
                {
                  this.state.loading ?
...
export default connect(mapState, mapDispatch)(withRouter(ContactUsList))