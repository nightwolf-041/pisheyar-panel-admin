...
import PanelMainSuggestionListhead from '../../panelMain/panelMainHeads/PanelMainSuggestionListhead'
...
class SuggestionList extends React.Component{
    ...
    render() {
        return (
            <>
            <PanelMain header={<PanelMainSuggestionListhead />}>
                {
                  this.state.loading ?
...
export default connect(mapState, mapDispatch)(withRouter(SuggestionList))