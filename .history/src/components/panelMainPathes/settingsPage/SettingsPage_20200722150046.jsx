...
import DiscountCreateModal from '../../UI/Modals/DiscountCreateModal';
...
function SettingsPage(props) {
  ...
  const [showDiscountCreateModal, setShowDiscountCreateModal] = React.useState(false);
  ...
  const showDiscountCreateModalHandler = () => {
    setShowDiscountCreateModal(true)
  }
  const hideDiscountCreateModal = () => {
    setShowDiscountCreateModal(false)
  }
...
// render() {
    return (
      <>
          ...
          <div className={classes.root} dir="rtl">
            <AppBar position="static" color="default">
              ...
              >
                ...
                <Tab label="استان ها" icon={<LocationOn />} {...a11yProps(1)} />
                <Tab label="کاربران" icon={<PeopleIcon />} {...a11yProps(2)} />
                <Tab label="مالی" icon={<MonetizationOn />} {...a11yProps(3)} />
            ...
            <TabPanel value={value} index={3}>
              ...
              <div className="layout-nav-setting-box-item"
              onClick={showDiscountCreateModalHandler}>
                <div className="layout-nav-setting-box-item-left">
                </div>
                <div className="layout-nav-setting-box-item-right">
                <FontAwesomeIcon icon={faCog} className="layout-nav-setting-box-item-right-icon"/>
        ...
        <DiscountCreateModal
        showDiscountCreateModal={showDiscountCreateModal}
        hideDiscountCreateModal={hideDiscountCreateModal}
        />
