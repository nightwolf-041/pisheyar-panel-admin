...
class PaymentsList extends React.Component{
    ...
    constructor(props){
        ...
        this.rangeDatePicker = React.createRef();
    }
    ...
    sortTableHandler = () => {
        console.log(this.rangeDatePicker.current.state.startDate._d);
        console.log(this.rangeDatePicker.current.state.endDate._d);

        axiosConfig.post('/Payment/GetAll', {
            contractorGuid: null,
            startDate: this.rangeDatePicker.current.state.startDate._d,
