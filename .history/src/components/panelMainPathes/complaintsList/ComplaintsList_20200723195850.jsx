...
import PanelMainComplaintsListhead from '../../panelMain/panelMainHeads/PanelMainComplaintsListhead'
import PanelMain from '../../panelMain/PanelMain'
import ShowMessageModal from '../../UI/Modals/ShowMessageModal'
...
class ComplaintsList extends React.Component{
    ...
    componentDidMount() {
        ...
        axiosConfig.get('/Complaint/GetAll', {
    ...
    showMessageModalHandler = message => {
      this.setState({clickedItemMessage: message}, () => {
        this.setState({showMessageModal: true})
      })
    }

    hideMessageModal = () => {
      this.setState({showMessageModal: false, clickedItemMessage: mesage})
    }

    render() {
        return (
            <>
            <PanelMain header={<PanelMainComplaintsListhead />}>
                {
                  this.state.loading ?
                    ...
                    <MaterialTable
                        ...
                        actions={[
                            ...
                            },
                            {
                              ...
                              tooltip: 'مشاهده پیام',
                              onClick: (event, rowData) => {
                                this.showMessageModalHandler(rowData.description)
                              }
                            },
                          ]}
                        editable={{
            ...
            message={this.state.clickedItemMessage}
            />
...
export default connect(mapState, mapDispatch)(withRouter(ComplaintsList))