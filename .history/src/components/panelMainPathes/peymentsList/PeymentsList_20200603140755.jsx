...
class PeymentsList extends React.Component{
    ...
    componentDidMount() {
        ...
        axiosConfig.get('/Payment/GetAll', {
          headers: { Authorization: "Bearer " + this.props.token }
            ...
            this.setState({
                loading: false,
                data: res.data.peyments
            })

            let data = res.data.peyments
            data.map(d => {
              if(d.trackingToken === true) {
                    ...
                    <MaterialTable
                        ...
                        onRowDelete: oldData =>
                          ...
                          new Promise((resolve, reject) => {
                            axiosConfig
                              .post(`/Order/Delete/${oldData.orderGuid}`, {
...
export default connect(mapState, mapDispatch)(withRouter(PeymentsList))