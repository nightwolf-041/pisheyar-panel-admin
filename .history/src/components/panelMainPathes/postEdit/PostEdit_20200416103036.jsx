     ...
     return (
      ...
      {/* <div className="filepond-keeper-box"> */}
        ...
        <Autocomplete
            ...
            fullWidth
            renderInput={(params) => <TextField {...params} label="درحال بارگیری..." variant="outlined" />}
          />
        }
          ...
          />
            ...
            <Autocomplete
              ...
              defaultValue={this.state.trimedValues}
              freeSolo
          ...
          {!this.state.loading ?
            ...
            <div className={classes.wrapper}>
                ...
                {this.state.loadingOnSend || this.state.this.state.loading && <CircularProgress size={24} className={classes.buttonProgress} />}
            </div>
