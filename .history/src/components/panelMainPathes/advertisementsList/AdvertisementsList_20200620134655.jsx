...
import PanelMainAdvertisementListhead from '../../panelMain/panelMainHeads/PanelMainAdvertisementListhead'
...
class AdvertisementsList extends React.Component{
    ...
    constructor(props){
        ...
        this.state = {
          ...
          showCreateAdvertisementModal: false,
...
export default connect(mapState, mapDispatch)(withRouter(AdvertisementsList))