...
class SliderPostsLists extends React.Component{
    ...
    componentDidMount() {
        ...
        axiosConfig.get('/Post/GetSliderPosts', {
...
export default connect(mapState, mapDispatch)(withRouter(SliderPostsLists))