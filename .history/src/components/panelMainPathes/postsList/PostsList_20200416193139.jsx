                          ...
                          // this.postDeleteHandler(oldData)
                            ...
                            new Promise((resolve, reject) => {
                              axiosConfig
                                ...
                                this.setState({reloadnigPosts: true})
                                  
                                  axiosConfig.get('/Post/GetAll', {
                                    headers: { Authorization: "Bearer " + this.props.token }
                                    }).then(res => {
                          
                                      if(this.state.reloadnigPosts) {
                                        resolve();
                                        let data = res.data.posts
                                        data.map(d => {
                                          if(d.postIsShow === true) {
                                        ...
                                        reject()
                                        toast('پست با موفقیت حذف شد', {type: toast.TYPE.WARNING});
                                      }
                                ...
                                this.setState({reloadnigPosts: false})
                                reject()
