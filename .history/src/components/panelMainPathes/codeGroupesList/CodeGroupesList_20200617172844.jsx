...
import PanelMainSliderPostsListhead from '../../panelMain/panelMainHeads/PanelMainSliderPostsListhead'
...
class CodeGroupesList extends React.Component{
    ...
    componentDidMount() {
        ...
        axiosConfig.get('/CodeGroup/GetAll', {
    ...
    render() {
        return (
            <>
            <PanelMain header={<PanelMainSliderPostsListhead />}>
                {
                  this.state.loading ?
                        ...
                        actions={[
                            {
                              ...
                              onClick: (event, rowData) => {
                                this.props.onSaveCodeGroupList(rowData.codeGroupGuid)
                                this.props.history.push('/codeGroupList' )
                                this.props.history.state = 'showCodeGroupList'
                              }
                            },
                          ]}
                    />
...
const mapDispatch = dispatch => {
    return {
        onSaveCodeGroupList: (groupeGuid) => dispatch(pagesActionCreators.saveCodeGroupList(groupeGuid))
    }
}

export default connect(mapState, mapDispatch)(withRouter(CodeGroupesList))