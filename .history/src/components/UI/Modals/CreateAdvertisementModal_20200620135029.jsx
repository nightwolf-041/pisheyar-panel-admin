...
function CreateAdvertisementModal(props) {
  ...
  const categoriesSetDetailsHandler = () => {
    if(documentGuidForCover === null || advertisementAbstract === '' || advertisementAbstract === ' ' || advertisementAbstract === null || advertisementDescription === '' || advertisementDescription === ' ' || advertisementDescription === null) {
