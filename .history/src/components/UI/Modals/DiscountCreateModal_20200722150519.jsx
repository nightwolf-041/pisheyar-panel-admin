...
function DiscountCreateModal(props) {
  ...
  const [discounType, setDiscounType] = React.useState('');
  ...
  useEffect(() => {
    axiosConfig.get('/fff?guid=43f6d743-3e89-4c5a-9971-625d7648ebdb', {
  ...
  const discountCreateHandler = () => {
    if(discountName !== '' || discountName !== ' ' || discountName !== null || discountValue !== '' || discountValue !== ' ' || discountValue !== null || discounType !== '' || discounType !== ' ' || discounType !== null || discountExpire !== '' || discountExpire !== ' ' || discountExpire !== null ) {
        ...
        axiosConfig.post('/Discount/CreatePublicDiscount', {
            name: discountName,
            value: discountValue,
            typeCodeGuid: "3fa85f64-5717-4562-b3fc-2c963f66afa6",
  ...
  const discounTypeChangeHandler = e => {
    setDiscounType(e.target.value)
  }
          ...
          <PerfectScrollbar>
            ...
            <Close className={classes.closeIocn} onClick={props.hideDiscountCreateModal} />
                ...
                <FormControl variant="outlined" className={classes.formControl}>
                    ...
                    className="textRight"
                    value={discounType}
                    onChange={discounTypeChangeHandler}
                    >
                    <MenuItem className="textRight" value='مرد'>
                        مرد
                    </MenuItem>
                    <MenuItem className="textRight" value='زن'>
                        زن
                    </MenuItem>
                    </Select>
                </FormControl>
