...
function AdminCreateModal(props) {
  ...
  const [adminFirstNameError, setAdminFirstNameError] = React.useState(false);
  const [adminLastName, setAdminLastName] = React.useState('');
  const [adminLastNameError, setAdminLastNameError] = React.useState(false);
  const [adminEmail, setAdminEmail] = React.useState('');
  const [adminEmailError, setAdminEmailError] = React.useState(false);
  const [adminPhoneNumber, setAdminPhoneNumber] = React.useState('');
  const [adminPhoneNumberError, setAdminPhoneNumberError] = React.useState(false);
  ...
  const categoriesSetDetailsHandler = () => {
    if(documentGuidForCover === null || advertisementURL === '' || advertisementURL === ' ' || adminFirstName === '' || adminFirstName === ' ' || adminFirstName === null || adminLastName === '' || adminLastName === ' ' || adminLastName === null) {
