...
function DiscountCreateModal(props) {
  ...
  const discountCreateHandler = () => {
    for (let type in discountTypes) {
        ...
        if(discountType === typeDisplayName){
        //   discountType = typeGuid
          setDiscountTypeGuid(typeGuid)
          console.log(typeGuid);
        }else{
        //   discountType = discountType
          setDiscountTypeGuid(discountType)
        }
    }
    // let finalDiscountType = value.split(' ')
    console.log(discountTypeGuid);
    let final = discountTypes.map(type => {
        if(discountType === type.displayName) {
            return type.codeGuid
        }
    })
    console.log(final);
