...
function DiscountCreateModal(props) {
  ...
  let fatePicker = React.useRef()

  const classes = styles();

  const discountCreateHandler = () => {
    if(discountName !== '' || discountName !== ' ' || discountName !== null || discountValue !== '' || discountValue !== ' ' || discountValue !== null || discountExpire !== '' || discountExpire !== ' ' || discountExpire !== null ) {
  ...
  const discountExpireInputHandler = e => {
    setDiscountExpire(e.target.value)
  }
        ...
        <Fade in={props.showDiscountCreateModal}>
          ...
          <PerfectScrollbar>
            ...
            <Close className={classes.closeIocn} onClick={props.hideDiscountCreateModal} />
                ...
                // error={true}
                variant="outlined"
                onChange={(e) => discountExpireInputHandler(e)}
                /> */}
                <DatePicker ref={datePicker}
                onClickSubmitButton={discountExpireInputHandler} />
