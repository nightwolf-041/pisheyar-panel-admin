...
function AdminCreateModal(props) {
  ...
  const categoriesSetDetailsHandler = () => {
    if(documentGuidForCover === null || adminFirstName === '' || adminFirstName === ' ' || adminFirstName === null || adminLastName === '' || adminLastName === ' ' || adminLastName === null || adminEmail === '' || adminEmail === ' ' || adminEmail === null || adminPhoneNumber === '' || adminPhoneNumber === ' ' || adminPhoneNumber === null || adminGender === '' || adminGender === ' ' || adminGender === null ) {
        ...
        let genderGuid = ''
        if(gender === "مرد") genderGuid = 'fffffff'
        else genderGuid = 'ggggggg'
  ...
  const adminGenderChangeHandler = e => {
          ...
          <PerfectScrollbar>
            ...
            <Close className={classes.closeIocn} onClick={props.hideAdminCreateModal} />
                ...
                <FormControl variant="outlined" className={classes.formControl}>
                    <InputLabel id="adminGender">جنسیت</InputLabel>
                    <Select
                    labelId="adminGender"
                    id="adminGender11"
                    label="جنسیت"
