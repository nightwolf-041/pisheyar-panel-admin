...
function CreateAdvertisementModal(props) {
  ...
  const categoriesSetDetailsHandler = () => {
    ...
    if(advertisementAbstract === '' || advertisementAbstract === ' ' || advertisementAbstract === null) {
        serAdvertisementAbstractError(true)
    }
    if(advertisementDescription === '' || advertisementDescription === ' ' || advertisementDescription === null) {
        setAdvertisementDescriptionError(true)
    }
