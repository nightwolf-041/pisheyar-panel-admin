...
function AdminCreateModal(props) {
  ...
  const [adminGender, setAdminGender] = React.useState({title: 'مرد', guid: 'ggg'});
          ...
          <PerfectScrollbar>
            ...
            <Close className={classes.closeIocn} onClick={props.hideAdminCreateModal} />
                ...
                <FormControl fullWidth variant="outlined" className={classes.formControl}>
                    <InputLabel id="adminGender11">جنسیت</InputLabel>
                    <Select
                    labelId="adminGender"
                    id="adminGender11"
                    value={adminGender.title}
                    onChange={adminGenderChangeHandler}
                    >
                    <MenuItem value={{title: 'مرد', guid: 'ggg'}}>مرد</MenuItem>
                    <MenuItem value={{title: 'زن', guid: 'yyy'}}>زن</MenuItem>
                    </Select>
                </FormControl>
{/* 
                <Select
