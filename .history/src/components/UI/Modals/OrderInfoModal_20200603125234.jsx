        ...
        <div className={classes.paper}>
            <PerfectScrollbar>
                ...
                {/* <Close className={classes.closeIocn} onClick={props.hideOrderInfoModal} /> */}
                    ...
                    <h5 id="transition-modal-title" className={classes.title}>:توضیح</h5>
                    <p className={classes.orderDescription}>
                        {description}
                    </p>
                    <h5 id="transition-modal-title" className={classes.title}>:نظر</h5>
                    <p className={classes.orderComment}>
                        {comment}
                    </p>
                    <h5 id="transition-modal-title" className={classes.title}>:امتیاز</h5>
                </div>
            </PerfectScrollbar>
        </div>
