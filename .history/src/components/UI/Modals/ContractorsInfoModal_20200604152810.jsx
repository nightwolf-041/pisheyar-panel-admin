...
function ContractorsInfoModal(props) {
  ...
  if(props.contractorInfoModalData !== null) {
    if(props.contractorInfoModalData.comment !== null){
      comment = props.contractorInfoModalData.comment
    }else{
  ...
  if(props.contractorInfoModalData !== null) {
    if(props.contractorInfoModalData.description !== null){
      description = props.contractorInfoModalData.description
    }
  }

  let rate = null
  if(props.contractorInfoModalData !== null) {
    if(props.contractorInfoModalData.rate !== null){
      rate = props.contractorInfoModalData.rate
    }
  }

  let cost = null
  if(props.contractorInfoModalData !== null) {
    if(props.contractorInfoModalData.cost !== null){
      cost = props.contractorInfoModalData.cost
    }else{
      cost = 'چت بسته نشده است'
    }
  }
        ...
        <div className={classes.paper}>
            <PerfectScrollbar>
                ...
                {/* <Close className={classes.closeIocn} onClick={props.hideOrderInfoModal} /> */}
                    ...
                    <h5 id="transition-modal-title" className={classes.title2}>:قیمت</h5>
