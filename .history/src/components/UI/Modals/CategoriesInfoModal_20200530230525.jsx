...
ForActiveIcon
  ...
  const [filesForCover, setFileForCover] = React.useState([]);
  const [filesForActiveIcon, setFileForActiveIcon] = React.useState([]);
  const [filesForInActive, setFileForInActive] = React.useState([]);
  const [filesForQuadMenu, setFileForQuadMenu] = React.useState([]);
