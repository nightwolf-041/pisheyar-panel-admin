    ...
    render() {
        ...
        if (this.props.showHamburger === true) {
            anime({
                ...
                duration: 500,
                // easing: 'linear'
                // easing: 'spring(1, 100, 7, 2)'
                easing: 'cubicBezier(.57,.21,.13,3.25)'
            })
        }
        else {
            anime({
                ...
                duration: 1000,
                // easing: 'linear',
                easing: 'cubicBezier(.57,.21,.69,3.25)'
            })
        }
...

                                    {
                                        item.linksInDrop ?
                                            ...
                                            <div className={
                                                ...
                                                [classes.layoutSidebarBodyTop1, classes.toggleBack, classes.layoutSidebarBodyClicked, classes.toggleBackBefored].join(' ')
                                            }
                                        ...
                                        <div key={item.id} className={
                                            ...
                                            [classes.layoutSidebarBodyTop2, classes.toggleBack, classes.layoutSidebarBodyClicked, classes.toggleBackBefored].join(' ')
                                        }
