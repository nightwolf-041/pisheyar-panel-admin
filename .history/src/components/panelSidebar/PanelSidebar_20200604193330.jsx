            ...
            itemsInSidebar: [
                ...
                },
                {
                    ...
                    linksInDrop: [
                        ...
                        { name: 'لیست منتخبین سردبیر', id: 'ltwo', path: '/montakhabList' },
                        { name: 'لیست اسلایدر', id: 'lthree', path: '/slidersList' },
                        { name: 'لیست تبلیغات', id: 'lfour', path: '/tablighatList' },
                    ]
                },
                {
                    name: 'پشتیبانی', id: 'five',
                    linksInDrop: [
                        { name: 'انتقادات و پیشنهاد ها', id: 'lone', path: '/enteghadhaList' },
                        { name: 'شکایات', id: 'ltwo', path: '/shekayatList' },
                        { name: 'ارتباط با ما', id: 'lthree', path: '/ertebatList' },
                        { name: 'تیکت ها', id: 'lfour', path: '/ticketList' },
                    ]
                },
