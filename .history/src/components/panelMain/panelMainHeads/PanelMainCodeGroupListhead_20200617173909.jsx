...
const PanelMainCodeGroupListhead = (props) => {
        ...
        <>
            ...
            <div className={classes.mainSectionHeader}>
                <div className={classes.mainSectionHeaderDescs}>
                    <h5 className={classes.mainSectionHeaderTitle}>لیست گروه ها</h5>
                    <p className={classes.mainSectionHeaderSubtitle}>گروه ها</p>
                </div>
...
export default PanelMainCodeGroupListhead