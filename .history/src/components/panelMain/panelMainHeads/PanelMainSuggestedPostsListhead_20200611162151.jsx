...
const PanelMainSuggestedPostshead = (props) => {
        ...
        <>
            ...
            <div className={classes.mainSectionHeader}>
                <div className={classes.mainSectionHeaderDescs}>
                    <h5 className={classes.mainSectionHeaderTitle}>لیست پست های منتخب</h5>
                    <p className={classes.mainSectionHeaderSubtitle}>پست منتخب سردبیر</p>
                </div>
...
export default PanelMainSuggestedPostshead