...
const SuggestedPostsLists = React.lazy(() =>
    import ('../components/panelMainPathes/suggestedPostsLists/SuggestedPostsList'))
...
const routs = [
    ...
    { exact: true, path: '/suggestedPostsLists', component: SuggestedPostsLists },
