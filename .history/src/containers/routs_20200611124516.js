...
const SuggestionPostsList = React.lazy(() =>
    import ('../components/panelMainPathes/suggestionPostsList/SuggestionPostsList'))
...
const routs = [
    ...
    { exact: true, path: '/suggestionPostsList', component: SuggestionPostsList },
